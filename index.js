...
(function($PS) {
  ...
  var TypeSynonym = (function () {
      function TypeSynonym(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      TypeSynonym.create = function (value0) {
          return function (value1) {
              return new TypeSynonym(value0, value1);
          };
      };
      return TypeSynonym;
  })();
  ...
  var Signal = (function () {
      function Signal(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Signal.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Signal(value0, value1, value2);
              };
          };
      };
      return Signal;
  ...
  var Conn = (function () {
      function Conn(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Conn.create = function (value0) {
          return function (value1) {
              return new Conn(value0, value1);
          };
      };
      return Conn;
  })();
  var Blk = (function () {
      function Blk(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Blk.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Blk(value0, value1, value2);
              };
          };
      };
      return Blk;
  })();
  var unwords = function (lc) {
      return Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_List_Types.monoidList)(new Data_List_Types.Cons(" ", Data_List_Types.Nil.value))(lc);
  };
  ...
  var $$var = function (v) {
      return v.value0 + (Data_Show.show(showDirection)(v.value2) + Data_Show.show(Data_Show.showInt)(v.value1));
  };
  var showDef = new Data_Show.Show(function (v) {
      if (v instanceof TypeSynonym) {
          return "TypeSynonym " + (Data_Show.show(Data_Show.showString)(v.value0) + (" " + Data_Show.show(Data_Show.showArray(Data_Show.showString))(v.value1)));
      };
      if (v instanceof Data) {
          return "Data " + Data_Show.show(Data_Show.showString)(v.value0);
      };
  ...
  var showBlock = new Data_Show.Show(function (v) {
      return "Blk " + (Data_Show.show(Data_Show.showString)(v.value0) + (" " + (Data_Show.show(Data_Show.showArray(Data_Show.showString))(v.value1) + (" " + Data_Show.show(Data_Show.showArray(Data_Show.showString))(v.value2)))));
  });
  var sepped = function (list) {
      return function (sep) {
          var lastStr = Data_Maybe.maybe("")(function (x) {
              return x;
          })(Data_Array.last(list));
          var initlist = Data_Maybe.maybe([  ])(function (x) {
              return x;
          })(Data_Array.init(list));
  ...
  var p = Text_Parsing_Parser_Token.makeTokenParser(Data_Identity.monadIdentity)(Text_Parsing_Parser_Language.haskellDef);
  var typeSynonymP = p.identifier;
  var listToStr = function (a) {
      return Data_String_CodeUnits.fromCharArray(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(a));
  };
  var singleP = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(listToStr)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(unwords)(Text_Parsing_Parser_Combinators.sepBy1(Data_Identity.monadIdentity)(Data_List.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_Token.alphaNum(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(" ")))))(Data_List.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_Token.alphaNum(Data_Identity.monadIdentity))));
  var singleP$prime = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function (a) {
      return new Data_List_Types.Cons(a, Data_List_Types.Nil.value);
  })(singleP);
  var tupleP = p.parens(Text_Parsing_Parser_Combinators.sepBy(Data_Identity.monadIdentity)(singleP)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(","))(p.whiteSpace)));
  var typeP = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(tupleP)(singleP$prime));
  var typedefP = Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(TypeSynonym.create)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("type"))(p.whiteSpace))(p.identifier))(p.whiteSpace))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("="))))(p.whiteSpace))(typeP);
  var gBundle = function (signals) {
      var v = Data_Array.length(signals);
      if (v === 0) {
          return "";
      };
      if (v === 1) {
          return Data_Maybe.maybe("")($$var)(Data_Array.index(signals)(0));
      };
  ...
  var gWhere = function (conns1) {
      return function (v) {
          ...
          var substituteConnection = function (initial) {
              return function (v1) {
                  if (v1.value0.value2 instanceof Out && v1.value1.value2 instanceof In) {
                      return Data_Maybe.maybe([  ])(function (x) {
                          return x;
                      })(Data_Array.updateAt(v1.value1.value1)(new Signal(v1.value0.value0, v1.value0.value1, Out.value))(initial));
                  };
                  return initial;
              };
          };
          ...
          var outputs = gBundle(outs);
          var insInitial = Data_Array.mapWithIndex(function (i) {
              return function (out) {
                  return new Signal(v.value0, i, In.value);
              };
          })(v.value1);
          var ins = Data_Foldable.foldl(Data_Foldable.foldableArray)(substituteConnection)(insInitial)(relevantConns);
          var inputs = gBundle(ins);
          var bundle = (function () {
              var v1 = Data_Array.length(v.value1);
              if (v1 === 0) {
                  return "";
              };
              if (v1 === 1) {
          ...
          var block = unbundle + (v.value0 + ("B" + bundle));
  ...
  var alldefsP = (function () {
      ...
      return Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(statements);
  })();
  var parse = function (str) {
      return Text_Parsing_Parser.runParser(str)(alldefsP);
  };
  exports["main"] = main;
  exports["compute"] = compute;
  exports["TypeSynonym"] = TypeSynonym;
  exports["Data"] = Data;
  exports["Block"] = Block;
  exports["p"] = p;
  exports["typeSynonymP"] = typeSynonymP;
  exports["listToStr"] = listToStr;
  exports["unwords"] = unwords;
  exports["singleP"] = singleP;
  exports["singleP'"] = singleP$prime;
  exports["tupleP"] = tupleP;
  exports["typeP"] = typeP;
  exports["typedefP"] = typedefP;
  exports["datadefP"] = datadefP;
  exports["blockdefP"] = blockdefP;
  exports["alldefsP"] = alldefsP;
  exports["parse"] = parse;
  exports["Blk"] = Blk;
  exports["Conn"] = Conn;
