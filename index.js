...
(function($PS) {
  ...
  var test = "type Operand = Signed 16\x0atype Addr = Unsigned 4\x0adata StackInstr = Push Operand | Pop | Nop\x0amealy stack :: StackInstr -> (Operand, Addr)\x0atype BRAMinput = (Addr, MaybeAddrOperand)\x0a";
  var showDef = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 43, column 1 - line 46, column 78): " + [ v.constructor.name ]);
  });
