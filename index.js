...
(function($PS) {
  ...
  var tupleP = p.parens(Text_Parsing_Parser_Combinators.sepBy(Data_Identity.monadIdentity)(p.identifier)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(","))(p.whiteSpace)));
